...
before packages are loaded."
  ...
  (setq
   ...
   rbenv-executable "/usr/local/bin/rbenv"
  ...
  (global-set-key (kbd "H-M-o") 'evil-unimpaired/previous-frame)
  (global-set-key (kbd "H-n") 'evil-window-down)
  (global-set-key (kbd "H-i") 'evil-window-up)
  (global-set-key (kbd "H-e") 'split-window-right-and-focus)
  (global-set-key (kbd "H-E") 'split-window-below-and-focus)
  (global-set-key (kbd "H-t") 'make-frame)
